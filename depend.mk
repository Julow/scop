...
O_FILES += $(O_DIR)/srcs/anim/anim_start.o $(O_DIR)/srcs/anim/anim_update.o \
	...
	$(O_DIR)/srcs/anim/smooth_out.o $(O_DIR)/srcs/mesh_loader/build_mesh.o \
	...
	$(O_DIR)/srcs/camera/camera_move.o \
	...
	$(O_DIR)/srcs/obj_anim/anim_c_shear.o $(O_DIR)/srcs/mtl_loader/load_mtl.o \
	...
	$(O_DIR)/srcs/renderer/simple_renderer.o $(O_DIR)/srcs/events/events.o \
	...
	$(O_DIR)/srcs/shader_loader/shader_get_uniform.o $(O_DIR)/srcs/utils/fps.o \
