...
O_FILES += $(O_DIR)/srcs/anim/anim_start.o $(O_DIR)/srcs/anim/anim_update.o \
	...
	$(O_DIR)/libft/ft_base/ft_unescape.o $(O_DIR)/libft/ft_base/mem/ft_bzero.o \
	...
	$(O_DIR)/libft/ft_sub/ft_subchr.o $(O_DIR)/libft/ft_sub/ft_subcount.o \
	$(O_DIR)/libft/ft_sub/ft_subequ.o $(O_DIR)/libft/ft_sub/ft_subextract.o \
	$(O_DIR)/libft/ft_sub/ft_subfloat.o $(O_DIR)/libft/ft_sub/ft_subindex.o \
	$(O_DIR)/libft/ft_sub/ft_subint.o $(O_DIR)/libft/ft_sub/ft_subnext.o \
	$(O_DIR)/libft/ft_sub/ft_subnextc.o $(O_DIR)/libft/ft_sub/ft_subsub.o \
	$(O_DIR)/libft/ft_sub/ft_subtrim.o $(O_DIR)/libft/ft_sub/ft_subtriml.o \
	$(O_DIR)/libft/ft_sub/ft_subtrimr.o $(O_DIR)/libft/ft_vector/ft_vclear.o \
...
$(O_DIR)/libft/ft_hmap/ft_hmaprem.o $(O_DIR)/libft/ft_hmap/hmap_puth.o: INCLUDE_FLAGS += \
...
$(O_DIR)/srcs/mesh_loader/parse_mesh_tokens.o \
$(O_DIR)/srcs/mesh_loader/parse_mesh_tokens_mtl.o \
$(O_DIR)/srcs/mesh_loader/send_mesh.o: INCLUDE_FLAGS += -Ilibft/ft_base/public \
	-Ilibft/ft_base/public -Ilibft/ft_sub/public -Ilibft/ft_hmap/public \
	-Ilibft/ft_list/public -Ilibft/ft_vector/public \
	-Ilibft/get_next_line/public -Ilibft/ft_printf/public \
	-Isrcs/math_utils/include -Isrcs/math_utils/include -Isrcs/utils/include \
	-Isrcs/mesh -Isrcs/mesh_loader/include -Isrcs/mesh_loader/include/public \
	-Isrcs/mtl -Isrcs/mtl_loader/include/public -Isrcs/texture -Isrcs/gl
...
# module utils
$(O_DIR)/srcs/utils/fps.o $(O_DIR)/srcs/utils/ft_error.o \
$(O_DIR)/srcs/utils/ft_listremove_next.o $(O_DIR)/srcs/utils/ft_subends.o \
$(O_DIR)/srcs/utils/ft_substart.o $(O_DIR)/srcs/utils/parse_fvec.o: INCLUDE_FLAGS += \
	-Ilibft/ft_base/public -Ilibft/ft_base/public -Ilibft/ft_sub/public \
...
$(O_DIR)/srcs/utils/ft_error.o: srcs/utils/ft_error.c \
	...
	libft/ft_out/public/ft_out.h srcs/utils/include/utils.h \
	| $(O_DIR)/srcs/utils/
...
$(O_DIR)/srcs/utils/parse_fvec.o: srcs/utils/parse_fvec.c \
	libft/ft_base/public/libft.h libft/ft_list/public/ft_list.h \
	libft/ft_printf/public/ft_printf.h libft/ft_sub/public/ft_sub.h \
	srcs/utils/include/utils.h | $(O_DIR)/srcs/utils/

# module ft::base
$(O_DIR)/libft/ft_base/ft_abs.o $(O_DIR)/libft/ft_base/ft_atoib.o \
$(O_DIR)/libft/ft_base/ft_escape.o $(O_DIR)/libft/ft_base/ft_is.o \
$(O_DIR)/libft/ft_base/ft_max.o $(O_DIR)/libft/ft_base/ft_min.o \
...
$(O_DIR)/libft/ft_base/mem/ft_bzero.o $(O_DIR)/libft/ft_base/mem/ft_emalloc.o \
$(O_DIR)/libft/ft_base/mem/ft_memcmp.o $(O_DIR)/libft/ft_base/mem/ft_memcpy.o \
$(O_DIR)/libft/ft_base/mem/ft_memdup.o $(O_DIR)/libft/ft_base/mem/ft_memfill.o \
$(O_DIR)/libft/ft_base/mem/ft_memmove.o \
$(O_DIR)/libft/ft_base/mem/ft_memrcpy.o $(O_DIR)/libft/ft_base/mem/ft_memset.o \
$(O_DIR)/libft/ft_base/mem/ft_memstart.o \
$(O_DIR)/libft/ft_base/mem/ft_memswap.o $(O_DIR)/libft/ft_base/misc/ft_clock.o \
$(O_DIR)/libft/ft_base/misc/ft_nanoclock.o \
$(O_DIR)/libft/ft_base/misc/ft_rand.o \
$(O_DIR)/libft/ft_base/misc/ft_randbool.o \
$(O_DIR)/libft/ft_base/wchar/ft_widetoa.o \
...
$(O_DIR)/srcs/mtl_loader/parse_mtl_tokens_map.o: INCLUDE_FLAGS += \
	-Ilibft/ft_base/public -Ilibft/ft_base/public -Ilibft/ft_sub/public \
	-Ilibft/ft_hmap/public -Ilibft/ft_list/public -Ilibft/get_next_line/public \
	...
	-Isrcs/texture -Isrcs/texture_loader/include/public
...
$(O_DIR)/srcs/mtl_loader/parse_mtl.o: srcs/mtl_loader/parse_mtl.c \
	libft/ft_base/public/libft.h libft/ft_hmap/public/ft_hmap.h \
	libft/ft_hmap/public/ft_hmap.h libft/ft_list/public/ft_list.h \
	libft/ft_sub/public/ft_sub.h libft/get_next_line/public/get_next_line.h \
...
$(O_DIR)/srcs/renderer/simple_renderer.o: INCLUDE_FLAGS += \
	-Ilibft/ft_base/public -Ilibft/ft_base/public -Ilibft/ft_hmap/public \
	-Ilibft/ft_list/public -Isrcs/anim/include -Isrcs/camera/include \
	-Isrcs/camera/include -Isrcs/math_utils/include -Isrcs/math_utils/include \
	...
	-Isrcs/shader_loader/include/public -Isrcs/mesh -Isrcs/mesh -Isrcs/mtl \
	-Isrcs/mtl -Isrcs/texture -Isrcs/texture -Isrcs/gl
...
# module events
$(O_DIR)/srcs/events/events.o: INCLUDE_FLAGS += -Ilibft/ft_base/public \
	-Ilibft/ft_base/public -Ilibft/ft_list/public -Isrcs/events/include \
	-Isrcs/utils/include -Isrcs/gl
...
$(O_DIR)/libft/ft_sub/ft_subnextc.o $(O_DIR)/libft/ft_sub/ft_subsub.o \
$(O_DIR)/libft/ft_sub/ft_subtrim.o $(O_DIR)/libft/ft_sub/ft_subtriml.o \
$(O_DIR)/libft/ft_sub/ft_subtrimr.o: INCLUDE_FLAGS += -Ilibft/ft_base/public \
	-Ilibft/ft_sub/public
...
$(O_DIR)/libft/ft_buff/ft_buffclear.o $(O_DIR)/libft/ft_buff/ft_buffget.o \
$(O_DIR)/libft/ft_buff/ft_parse.o $(O_DIR)/libft/ft_buff/ft_parsebase.o \
$(O_DIR)/libft/ft_buff/ft_parsedouble.o $(O_DIR)/libft/ft_buff/ft_parseendl.o \
$(O_DIR)/libft/ft_buff/ft_parsef.o $(O_DIR)/libft/ft_buff/ft_parseint.o \
$(O_DIR)/libft/ft_buff/ft_parselong.o $(O_DIR)/libft/ft_buff/ft_parsen.o \
$(O_DIR)/libft/ft_buff/ft_parsenot.o $(O_DIR)/libft/ft_buff/ft_parsespace.o \
$(O_DIR)/libft/ft_buff/ft_parsestr.o $(O_DIR)/libft/ft_buff/ft_parsewhite.o \
...
$(O_DIR)/srcs/shader_loader/shader_get_uniform.o: INCLUDE_FLAGS += \
	-Ilibft/ft_base/public -Ilibft/ft_base/public -Ilibft/ft_sub/public \
	-Ilibft/ft_hmap/public -Ilibft/ft_hmap/public -Ilibft/ft_list/public \
	-Ilibft/get_next_line/public -Ilibft/ft_printf/public -Isrcs/utils/include \
	-Isrcs/shader -Isrcs/shader_loader/include \
	-Isrcs/shader_loader/include/public -Isrcs/gl
$(O_DIR)/srcs/shader_loader/compile_shader.o: \
	srcs/shader_loader/compile_shader.c libft/ft_base/public/ft_colors.h \
	libft/ft_base/public/libft.h libft/ft_hmap/public/ft_hmap.h \
	libft/ft_list/public/ft_list.h libft/ft_list/public/ft_list.h \
...
# module ft::vector
$(O_DIR)/libft/ft_vector/ft_vclear.o $(O_DIR)/libft/ft_vector/ft_vpush_back.o \
$(O_DIR)/libft/ft_vector/ft_vremove.o $(O_DIR)/libft/ft_vector/ft_vreserve.o: INCLUDE_FLAGS += \
...
$(O_DIR)/srcs/main/main.o $(O_DIR)/srcs/main/motions.o: INCLUDE_FLAGS += \
	-Ilibft/ft_base/public -Ilibft/ft_hmap/public -Ilibft/ft_list/public \
	-Ilibft/ft_vector/public -Ilibft/ft_printf/public -Isrcs/anim/include \
	-Isrcs/camera/include -Isrcs/events/include -Isrcs/math_utils/include \
	-Isrcs/obj/include -Isrcs/obj_anim/include -Isrcs/renderer/include/public \
	-Isrcs/transform/include -Isrcs/utils/include -Isrcs/shader -Isrcs/mesh \
	-Isrcs/mesh_loader/include/public -Isrcs/mtl -Isrcs/texture \
	-Isrcs/main/include -Isrcs/gl
...
# module obj_anim
$(O_DIR)/srcs/obj_anim/anim_c_move.o $(O_DIR)/srcs/obj_anim/anim_c_rot.o \
$(O_DIR)/srcs/obj_anim/anim_c_scale.o $(O_DIR)/srcs/obj_anim/anim_c_shear.o: INCLUDE_FLAGS += \
	-Ilibft/ft_base/public -Isrcs/anim/include -Isrcs/camera/include \
	-Isrcs/math_utils/include -Isrcs/obj/include -Isrcs/obj_anim/include \
	-Isrcs/transform/include -Isrcs/mesh -Isrcs/mtl -Isrcs/texture
...
# module anim
$(O_DIR)/srcs/anim/anim_start.o $(O_DIR)/srcs/anim/anim_update.o \
$(O_DIR)/srcs/anim/smooth_back_in.o $(O_DIR)/srcs/anim/smooth_back_in_out.o \
$(O_DIR)/srcs/anim/smooth_back_out.o $(O_DIR)/srcs/anim/smooth_bounce.o \
$(O_DIR)/srcs/anim/smooth_elastic.o $(O_DIR)/srcs/anim/smooth_in.o \
$(O_DIR)/srcs/anim/smooth_in_out.o $(O_DIR)/srcs/anim/smooth_linear.o \
...
# module ft::out
$(O_DIR)/libft/ft_out/ft_flush.o $(O_DIR)/libft/ft_out/ft_hexdump.o \
$(O_DIR)/libft/ft_out/ft_out.o $(O_DIR)/libft/ft_out/ft_write.o \
$(O_DIR)/libft/ft_out/ft_writebase.o $(O_DIR)/libft/ft_out/ft_writechar.o \
$(O_DIR)/libft/ft_out/ft_writedouble.o $(O_DIR)/libft/ft_out/ft_writeint.o \
$(O_DIR)/libft/ft_out/ft_writenchar.o $(O_DIR)/libft/ft_out/ft_writenl.o \
...
$(O_DIR)/libft/ft_dstr/ft_dstrextend.o $(O_DIR)/libft/ft_dstr/ft_dstrspan.o: INCLUDE_FLAGS += \
...
$(O_DIR)/srcs/math_utils/ft_mat4translate.o \
$(O_DIR)/srcs/math_utils/ft_mat4transpose.o \
$(O_DIR)/srcs/math_utils/ft_vec3cross.o $(O_DIR)/srcs/math_utils/ft_vec3dot.o \
$(O_DIR)/srcs/math_utils/ft_vec3front.o $(O_DIR)/srcs/math_utils/ft_vec3norm.o \
$(O_DIR)/srcs/math_utils/ft_vec3rotate.o $(O_DIR)/srcs/math_utils/ft_vec3sub.o: INCLUDE_FLAGS += \
	-Isrcs/math_utils/include
...
# module ft::printf
$(O_DIR)/libft/ft_printf/args_utils.o $(O_DIR)/libft/ft_printf/flags/flag_b.o \
$(O_DIR)/libft/ft_printf/flags/flag_c.o \
$(O_DIR)/libft/ft_printf/flags/flag_d.o \
$(O_DIR)/libft/ft_printf/flags/flag_f.o \
$(O_DIR)/libft/ft_printf/flags/flag_n.o \
...
$(O_DIR)/libft/ft_printf/flags/flag_u.o \
$(O_DIR)/libft/ft_printf/flags/flag_w.o \
$(O_DIR)/libft/ft_printf/flags/flag_x.o $(O_DIR)/libft/ft_printf/flags_utils.o \
$(O_DIR)/libft/ft_printf/ft_aprintf.o $(O_DIR)/libft/ft_printf/ft_asprintf.o \
$(O_DIR)/libft/ft_printf/ft_fdprintf.o $(O_DIR)/libft/ft_printf/ft_printf.o \
$(O_DIR)/libft/ft_printf/ft_snprintf.o $(O_DIR)/libft/ft_printf/ft_sprintf.o \
$(O_DIR)/libft/ft_printf/ft_writef.o $(O_DIR)/libft/ft_printf/metas/meta_fl.o \
$(O_DIR)/libft/ft_printf/metas/meta_nl.o \
$(O_DIR)/libft/ft_printf/metas_utils.o $(O_DIR)/libft/ft_printf/parse_format.o \
$(O_DIR)/libft/ft_printf/parse_meta.o $(O_DIR)/libft/ft_printf/writef.o: INCLUDE_FLAGS += \
	-Ilibft/ft_base/public -Ilibft/ft_base/public -Ilibft/ft_dstr/public \
	-Ilibft/ft_out/public -Ilibft/ft_printf -Ilibft/ft_printf/public
...
$(O_DIR)/srcs/texture_loader/tga_parser.o: INCLUDE_FLAGS += \
	-Ilibft/ft_base/public -Ilibft/ft_base/public -Ilibft/ft_buff/public \
	-Ilibft/ft_hmap/public -Ilibft/ft_list/public -Isrcs/utils/include \
	-Isrcs/texture -Isrcs/texture_loader/include \
	-Isrcs/texture_loader/include/public -Isrcs/gl
$(O_DIR)/srcs/texture_loader/ft_loadimage.o: \
...
$(O_DIR)/srcs/texture_loader/tga_parser.o: srcs/texture_loader/tga_parser.c \
	libft/ft_base/public/libft.h libft/ft_buff/public/ft_buff.h \
	libft/ft_buff/public/ft_buff.h libft/ft_list/public/ft_list.h \
