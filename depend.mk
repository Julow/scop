...
OBJ_DIR_TREE += $(O_DIR)/srcs/utils/ $(O_DIR)/srcs/texture_loader/ \
	...
	$(O_DIR)/libft/ft_list/ $(O_DIR)/libft/ft_in/ \
...
PUBLIC_LINKS += $(O_DIR)/_public/anim.h $(O_DIR)/_public/camera.h \
	$(O_DIR)/_public/events.h $(O_DIR)/_public/ft/file.h \
