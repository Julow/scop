...
LIBS_RULES += libft
O_FILES += $(O_DIR)/srcs/camera/camera_get_view.o \
	...
	$(O_DIR)/srcs/utils/parse_fvec.o $(O_DIR)/srcs/main/callbacks.o \
	$(O_DIR)/srcs/main/init_window.o $(O_DIR)/srcs/main/main.o \
	$(O_DIR)/srcs/main/motions.o $(O_DIR)/srcs/anim/anim_start.o \
	$(O_DIR)/srcs/anim/anim_update.o $(O_DIR)/srcs/anim/smooth_back_in.o \
...
$(O_DIR)/srcs/mesh_loader/parse_mesh_tokens.o: INCLUDE_FLAGS += -Ilibft \
	-Isrcs/gl -Isrcs/math_utils/include -Isrcs/mesh_loader/include \
	-Isrcs/mtl_loader/include -Isrcs/texture_loader/include \
	-Isrcs/utils/include
$(O_DIR)/srcs/mesh_loader/parse_mesh_tokens.o: \
...
$(O_DIR)/srcs/mtl_loader/load_mtl.o: INCLUDE_FLAGS += -Ilibft \
	-Isrcs/math_utils/include -Isrcs/mtl_loader/include \
	-Isrcs/texture_loader/include -Isrcs/utils/include
...
$(O_DIR)/srcs/obj_anim/anim_c_move.o: INCLUDE_FLAGS += -Ilibft \
	-Isrcs/anim/include -Isrcs/math_utils/include -Isrcs/mesh_loader/include \
	-Isrcs/mtl_loader/include -Isrcs/obj/include -Isrcs/obj_anim/include \
	-Isrcs/texture_loader/include -Isrcs/transform/include
...
$(O_DIR)/srcs/renderer/simple_renderer.o: INCLUDE_FLAGS += -Ilibft \
	...
	-Isrcs/math_utils/include -Isrcs/mesh_loader/include \
	-Isrcs/mtl_loader/include -Isrcs/obj/include -Isrcs/renderer/include \
	-Isrcs/shader_loader/include -Isrcs/texture_loader/include \
...
$(O_DIR)/srcs/shader_loader/compile_shader.o: INCLUDE_FLAGS += -Ilibft \
	-Isrcs/gl -Isrcs/shader_loader/include -Isrcs/utils/include
$(O_DIR)/srcs/shader_loader/compile_shader.o: \
...
$(O_DIR)/srcs/shader_loader/load_shader.o: INCLUDE_FLAGS += -Ilibft -Isrcs/gl \
	-Isrcs/shader_loader/include -Isrcs/utils/include
...
$(O_DIR)/srcs/texture_loader/ft_loadimage.o: INCLUDE_FLAGS += -Ilibft \
	-Isrcs/gl -Isrcs/texture_loader/include -Isrcs/utils/include
$(O_DIR)/srcs/texture_loader/ft_loadimage.o: \
...
$(O_DIR)/srcs/main/callbacks.o: INCLUDE_FLAGS += -Ilibft -Isrcs/anim/include \
	...
	-Isrcs/math_utils/include -Isrcs/mesh_loader/include \
	-Isrcs/mtl_loader/include -Isrcs/obj/include -Isrcs/obj_anim/include \
	-Isrcs/renderer/include -Isrcs/shader_loader/include \
	-Isrcs/texture_loader/include -Isrcs/transform/include \
	-Isrcs/utils/include
