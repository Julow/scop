...
/*   Updated: 2016/11/22 12:26:41 by jaguillo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		child_rotate(t_obj *obj, t_vec3 const *rotate)
{
	...
	obj->world_transform.rotation =
		VEC3_ADD(obj->world_transform.rotation, *rotate);
	i = 0;
	while (i < obj->childs.length)
		child_rotate(*(t_obj**)VECTOR_GET(obj->childs, i++), rotate);
}
